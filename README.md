...
A trigger edge puts signal on the output **35 µs later** (`CAL STARTLAT`, adjustable), repeatable
to 42 ns, plus whatever `DELAY` asks for. The 35 µs is almost all the arm — the copy and
